                ...
                value: function (text, say, allowHtml, extra) {
					...
					if(!window.muteAudio) {
							if (window.sapi) {
								...
								{
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"");
								} else if (this.userPublic.color == "rover") {
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=paul");
								} else if (this.userPublic.color == "god") {
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=robosoft2");
									...
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=merlin");
									...
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=mike");
									...
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=Genius");
									...
									var audio = new Audio("http://"+window.location.hostname+":"+SAPI_PORT+"/api/v1/sapi?text="+ encodeURIComponent(say) + "&pitch="+_this3.userPublic.pitch+"&speed="+_this3.userPublic.speed+"&guid="+_this3.id+"&char=Robby");
