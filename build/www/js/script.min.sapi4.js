                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        if (this.userPublic.color == "rover" || this.userPublic.color == "dogpope") {
                            a = new Audio("http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Sam&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed);
                        } else if (this.userPublic.color == "robby") {
                            a = new Audio(
                                "http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Robby&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
                            );
                        } else if (this.userPublic.color == "merlin" || this.userPublic.color == "losky") {
                            a = new Audio(
                                "http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Merlin&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
                            );
                        } else if (this.userPublic.color == "genie" || this.userPublic.color == "clippy" || this.userPublic.color == "red_clippy"  || this.userPublic.color == "clippypope" || this.userPublic.color == "qmark" || this.userPublic.color == "pm" || this.userPublic.color == "unbojih") {
                            a = new Audio(
                                "http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Genie&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
                            );
                        } else if (this.userPublic.color == "genie" || this.userPublic.color == "clippy" || this.userPublic.color == "red_clippy"  || this.userPublic.color == "clippypope" || this.userPublic.color == "qmark" || this.userPublic.color == "pm" || this.userPublic.color == "unbojih") {
                            a = new Audio(
                                "http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Genie&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
                            ...
                            a = new Audio(
                                "http://"+ window.location.hostname +"/SAPI4/SAPI4?text=" + encodeURIComponent(text) + "&voice=Bonzi&pitch=" + this.userPublic.pitch + "&speed=" + this.userPublic.speed
                            );
                        }
                        a.play();
                        a.onended = function () {
