    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            (this.x = e.x * this.rng()),
                        ...
                        return {
                            items: {
                                ...
                                mute: {
                                    ...
                                    callback: function () {
                                        if (!d.mute) {
                                            socket.emit("command", { list: ["muted", d.userPublic.name] });
                                        }
                ...
                setTimeout(function () {
                    if (d.color != "clippy" && d.color != "peedy") {
                        var a = new Audio("jump_off.wav");
                        a.play();
                    }
                }, 2000);
        }
            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialogCont.html(" <video width='170' height='170' controls autoplay><source src='" + a + "' type='video/mp4'>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialogCont.html("<img width='170' height='170' src='" + a + "'></img>"), this.$dialog.show();
                        }
                    },
                },
                {
                ...
                },
                {
                    key: "surf",
                    value: function () {
                        var a = [{ type: "anim", anim: "surf_across_still", ticks: 15 }];
                        this.runSingleEvent(a);
                    },
                },
                {
    ...
    BonziData = {
        ...
        sprite: {
            ...
            animations: {
                ...
                surf_intro: [277, 302, "idle", 0.8],
                surf_intro_emote: [277, 302, "wave", 0.8],
                surf_away: [16, 38, "gone", 0.8],
                ...
                banana_fwd: [344, 355, "idle", 0.6],
                banana_fwd: [344, 355, "banana_back", 0.6],
...
var undefined,
    site_name = "24.101.12.28",
    socket = io("http://" + site_name + ":3000"),
    usersPublic = {},
    bonzis = {},
    debug = !0;
$(function () {
