    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", speed: 175, pitch: 50, amplitude: 100, voice: "m1", _extras: {} }),
            ...
            (this.x = e.x * this.rng()),
                ...
                setTimeout(function () {
                    ...
                    if (d.color == "unbojih") {
                        var aud = new Audio("unbojih_enter.wav");
                        aud.play();
                        var a2 = new Audio("port_suckin1.wav");
                        a2.play();
                    }
                    if (d.color == "genius") {
                        var aud = new Audio("genius_surf.wav");
        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "muted",
                    value: function () {
                        var a = [{ type: "anim", anim: "muted_fwd" }];
                        this.runSingleEvent(a);
                    },
                },
                {
