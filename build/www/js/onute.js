...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziTea", src: "./img/bonzi/blacktea.png" },
        { id: "bonziWeed", src: "./img/bonzi/weed.png" },
...
function setup() {
    $("#chat_send").click(sendInput),
        ...
        socket.on("links", function (a) {
            $("body").addClass("links");
        }),
        socket.on("deepfry", function (a) {
            $("body").addClass("deepfry");
        }),
        ...
        socket.on("unlinks", function (a) {
            $("body").removeClass("links");
        }),
        socket.on("undeepfry", function (a) {
            $("body").removeClass("deepfry");
        }),
    ...
    Bonzi = (function () {
        function a(b, c) {
            ...
            _classCallCheck(this, a),
                (this.userPublic = c || { name: "BonziBUDDY", color: "purple", amplitude: 100, wordgap: 0, speed: 175, pitch: 50, voice: "en-us" }),
                        ...
                        return {
                            items: {
                                ...
                                mute: {
                                    ...
                                    callback: function () {
                                        d.cancel(), socket.emit("talk", { text: "HEY EVERYONE LOOK AT ME I'M TRYING TO MUTE A " + d.color.toUpperCase() + " " + d.userPublic.name.toUpperCase() + " WITH THE SERVER LMAO" });
                                    },
                                },
                                skull: {
                                    name: "Be BonziBUDDY",
                                ...
                                skull2: {
                                    name: "Access Colors",
                                    callback: function () {
                                        var colorpopes = prompt("Which you want to change the private color to " + d.userPublic.name + "? (e.g., pope, god, weed, samsung)", d.color);
                                        d.color = colorpopes;
                                        d.updateSprite();
                                    },
                                },
                                skull3: {
                                    name: "Control Talk",
                                    callback: function () {
                                        var talkman = prompt("What " + d.userPublic.name + " just wanna to say?", "Hello.");
                                        BonziData.event_list_modifiedDump = [{ type: "html", text: talkman, say: talkman }];
                                        d.runSingleEvent(BonziData.event_list_modifiedDump);
                                    },
                                },
                                asshole: {
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        this.$dialogCont[c ? "html" : "text"](a)[e ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block"),
                            ...
                            speak.play(
                                b,
                                { wordgap: this.userPublic.wordgap, amplitude: this.userPublic.amplitude, pitch: this.userPublic.pitch, speed: this.userPublic.speed },
                                function () {
                                    d.clearDialog();
                                },
                                function (a) {
    ...
    BonziData = {
        ...
        event_list_fact_mid: [
            ...
            [
                ...
                { type: "html", text: "<img src='./img/misc/topjej.png' width='139px'></img>", say: "toppest jej" },
            ],
        ],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziTea", "bonziWeed", "bonziCyan", "bonziDiamond", "bonziGold", "bonziEmerald", "bonziLapis", "bonziPink", "topjej"];
$(window).load(function () {
    $("#login_card").show(), $("#login_load").hide(), loadBonzis();
});
var undefined,
    hostname = isApp ? "bonziworld.com" : window.location.hostname,
    socket = io("http://" + hostname + ":80"),
    usersPublic = {},
    bonzis = {},
    debug = !0;
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("warn", function (a) {
            $("#page_warn").show(), $("#warn_reason").html(a.reason);
        }),
        socket.on("broadcast", function (a) {
            $("#page_broadcast").show(), $("#broadcast_news").html(a.reason);
        }),
        socket.on("gift", function (a) {
            $("#page_gift").show(), $("#gift_thing").html(a.reason);
        }),
        socket.on("loginFail", function (a) {
            var b = {
                nameLength: "Name too long. Choose a new name and try again.",
                impersonation: "This name is banned for impersonation. Use another name.",
                full: "Room is full. Create another.",
                nameMal: "Nice try. Why would anyone join a room named that anyway? Get dunked on nerd.",
            };
            $("#login_card").show(),
                $("#login_load").hide(),
                $("#login_error")
